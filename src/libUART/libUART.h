...
extern LIBUART_API int libUART_get_dev(uart_t *uart, char **dev);
extern LIBUART_API int libUART_set_databits(uart_t *uart, int data_bits);
extern LIBUART_API int libUART_get_databits(uart_t *uart, int *data_bits);
extern LIBUART_API int libUART_set_parity(uart_t *uart, int parity);
extern LIBUART_API int libUART_get_parity(uart_t *uart, int *parity);
extern LIBUART_API int libUART_set_stopbits(uart_t *uart, int stop_bits);
extern LIBUART_API int libUART_get_stopbits(uart_t *uart, int *stop_bits);
extern LIBUART_API int libUART_set_flowctrl(uart_t *uart, int flow_ctrl);
extern LIBUART_API int libUART_get_flowctrl(uart_t *uart, int *flow_ctrl);
